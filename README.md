...
To run this Node.js game, download this repo and run `node start-node-game.js` in your terminal. The log will show how the AI is working to guess the hangman word, and also whether or not it is able to guess the word.
...
3. Makes another `POST` request to guess the first letter in the `freqList`.
